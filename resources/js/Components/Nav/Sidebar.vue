<template>
    ...
    <section class="min-h-full">
      <div class="flex flex-col border-r py-8 pr-10 pl-4 min-w-max">
        ...
        <Link href="/admin/purchases" class="text-xl pb-12 inline-flex items-center group " :class="{'text-yellow': $page.component.startsWith('Admin/Purchases') }">
          <svg class="fill-white group-hover:fill-yellow mr-3 min-w-max" :class="{'fill-yellow': $page.component.startsWith('Admin/Purchases') }" xmlns="http://www.w3.org/2000/svg" width="17.94" height="14.576" viewBox="0 0 17.94 14.576">
