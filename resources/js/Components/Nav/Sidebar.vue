<template>
    ...
    <div v-if="$page.props.auth.user.admin" class="h-[calc(100vh-10rem)] md:h-[calc(100vh-12rem)] sticky top-40 flex flex-col items-center md:items-start border-r py-8 pr-6 pl-2 md:pr-10 md:pl-4 md:min-w-max">
        <Link href="rewards" class="text-xl pb-12 inline-flex items-center group" :class="{'text-yellow': $page.component.startsWith('Admin/Rewards') }">
        ...
        <Link href="credits" class="text-xl pb-12 inline-flex items-center group" :class="{'text-yellow': $page.component.startsWith('Admin/Credits') }">
        ...
        <Link href="users" class="text-xl pb-12 inline-flex items-center group" :class="{'text-yellow': $page.component.startsWith('Admin/Users') }">
